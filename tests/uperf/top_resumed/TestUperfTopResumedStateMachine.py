...
VERIFIER = REPO / "scripts/build/VerifyZuiControlFinalSuper.ps1"
FIXTURE = pathlib.Path(__file__).with_name("TopResumedStateMachineTest.java")
    ...
    def test_state_machine_executes_all_required_fixtures(self):
        with tempfile.TemporaryDirectory() as output:
            ...
            completed = subprocess.run(
                ["java", "-cp", output,
                 "com.zui.server.control.TopResumedStateMachineTest"],
                check=True,
                text=True,
