#!/usr/bin/env python3
"""Host-only state-machine and production-binding tests for Refresh."""
...
class ProductionBindingTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.final_super_verifier = read("scripts/build/VerifyZuiControlFinalSuper.ps1")
        cls.flash_verifier = read("scripts/build/VerifyZuiControlFlashPackage.ps1")
...
"""
    ...
    def test_configuration_and_physical_axes_are_separate(self) -> None:
        ...
        # R6 restores direct Refresh via that same accepted editable-scene transaction.
